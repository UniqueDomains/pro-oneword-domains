# Available .PRO One-Word Domains (72,865)

<p align="left">
  <img alt="status" src="https://img.shields.io/badge/status-active-2ea44f">
  <img alt="updated" src="https://img.shields.io/badge/updated-daily-0969da">
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-1%2C000%20rows-8250df">
  <img alt="live catalog" src="https://img.shields.io/badge/live%20catalog-72%2C865%20domains-6f42c1">
...
> The full live catalog for this exact search currently contains **72,865 domains** on the canonical page below.

**Public extract:** 1,000 rows · **Live catalog:** 72,865 domains · **Median ask:** $69.40 · **High-demand under $2,500:** 108
...
| ----------------------- | ------------------------------------------ |
| 1,000-row public sample | 72,865 live domains                        |
| Static CSV / JSON       | live search and daily refresh              |
| Basic exported fields   | 108 high-demand names under $2,500         |
...
> Unique Domains. *Available .PRO One-Word Domains*. Version 2026-09-14. Public GitHub extract for the exact Unique Domains search represented by this repository.
